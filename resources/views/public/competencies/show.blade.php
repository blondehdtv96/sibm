        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl p-6 sticky top-24">
                    ...
                    @else
                        <div class="mb-6">
                            <div class="w-full h-48 rounded-xl bg-gradient-to-br from-green-500 to-blue-600 flex items-center justify-center border-4 border-white shadow-lg">
                    ...
                    <div class="text-center mb-6">
                        ...
                        <p class="text-green-600 font-medium">Program Keahlian</p>
                    </div>
                        ...
                        <div class="space-y-2">
                            @if($otherCompetencies->count() > 0)
                                @foreach($otherCompetencies->take(5) as $other)
                                    <a href="{{ route('public.competencies.show', $other) }}" class="flex items-center p-2 text-sm text-gray-600 hover:text-green-600 hover:bg-white rounded-lg transition">
                                ...
                                @endforeach
                            @endif
                            <a href="{{ route('public.competencies.index') }}" class="flex items-center p-2 text-sm text-gray-600 hover:text-green-600 hover:bg-white rounded-lg transition">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"></path>
                                </svg>
                                Lihat Semua Program
                            </a>
                            <a href="{{ route('info.contact') }}" class="flex items-center p-2 text-sm text-gray-600 hover:text-green-600 hover:bg-white rounded-lg transition">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-xl p-6 border-2 border-green-100 mb-8">
                    ...
                    <div class="flex flex-col md:flex-row gap-6 items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-green-600 font-medium mb-4">Kepala Program {{ $competency->name }}</p>
                            @endif
                ...
                <div class="bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl p-8 mb-8 border-l-4 border-green-500">
                    <svg class="w-10 h-10 text-green-400 mb-4" fill="currentColor" viewBox="0 0 24 24">
...
<section class="py-16 bg-gradient-to-br from-green-600 via-blue-600 to-purple-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('ppdb.register') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white text-green-600 font-semibold rounded-xl hover:bg-green-50 transition shadow-lg hover:shadow-xl">
                Daftar PPDB
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                </svg>
            </a>
            <a href="{{ route('info.contact') }}" class="inline-flex items-center justify-center px-8 py-4 bg-green-700 text-white font-semibold rounded-xl hover:bg-green-800 transition border-2 border-white/20">
                Hubungi Kami
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
