...
@section('content')
<!-- Hero Section -->
<section class="relative bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 text-white py-20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 sticky top-24">
                    ...
                    @else
                        <div class="mb-6">
                            <div class="w-32 h-32 rounded-full mx-auto bg-emerald-200 flex items-center justify-center border-4 border-white shadow-lg">
                    ...
                    <div class="border-t border-emerald-200 pt-6">
                        ...
                        <div class="space-y-2">
                            <a href="{{ route('info.about') }}" class="flex items-center p-2 text-sm text-gray-600 hover:text-emerald-600 hover:bg-white rounded-lg transition">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                                </svg>
                                Profil Sekolah
                            </a>
                            <a href="{{ route('info.overview') }}" class="flex items-center p-2 text-sm text-gray-600 hover:text-emerald-600 hover:bg-white rounded-lg transition">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                                Selayang Pandang
                            </a>
                            <a href="{{ route('info.contact') }}" class="flex items-center p-2 text-sm text-gray-600 hover:text-emerald-600 hover:bg-white rounded-lg transition">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-8 mb-8 border-l-4 border-emerald-500">
                    <svg class="w-10 h-10 text-emerald-400 mb-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white rounded-xl p-6 border-2 border-emerald-100 hover:border-emerald-300 transition">
                    ...
                    <div class="bg-white rounded-xl p-6 border-2 border-teal-100 hover:border-teal-300 transition">
...
<!-- CTA Section -->
<section class="py-16 bg-gradient-to-br from-emerald-600 to-teal-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('ppdb.register') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white text-emerald-600 font-semibold rounded-xl hover:bg-emerald-50 transition shadow-lg hover:shadow-xl">
                Daftar PPDB
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                </svg>
            </a>
            <a href="{{ route('info.contact') }}" class="inline-flex items-center justify-center px-8 py-4 bg-emerald-700 text-white font-semibold rounded-xl hover:bg-emerald-800 transition border-2 border-white/20">
                Hubungi Kami
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
