...
<div class="space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Unggah gambar pengumuman baru</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.announcements.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-6">
            ...
            <div>
                <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Gambar Pengumuman <span class="text-red-500">*</span></label>
                <input type="file" name="image" id="image" accept="image/*" onchange="previewImage(event)"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('image') border-red-500 @enderror" required>
                <p class="mt-1 text-sm text-gray-500">Format: JPG, PNG, WEBP. Maksimal 10MB</p>
            ...
            <div>
                ...
                <input type="url" name="link_url" id="link_url" value="{{ old('link_url') }}" placeholder="https://example.com"
