...
@php
    ...
    $pageDescription = 'Add a new user account';
    $breadcrumbs = [
...
@section('content')
<div class="ios-card">
    <form method="POST" action="{{ route('admin.users.store') }}" enctype="multipart/form-data" x-data="{ 
        previewImage: null,
        showPassword: false,
        ...
        <div class="ios-card-body">
            <div class="ios-grid ios-grid-cols-1 ios-gap-lg">
                ...
                <!-- Password -->
                <div class="ios-form-group">
                    <label for="password" class="ios-form-label">Password *</label>
                ...
                <div class="ios-form-group">
                    <label for="password_confirmation" class="ios-form-label">Confirm Password *</label>
                    <div class="ios-input-group">
                        <input 
        ...
        <div class="ios-card-footer">
            <div class="ios-flex ios-items-center ios-justify-end ios-gap-sm">
                <a href="{{ route('admin.users.index') }}" class="ios-button-ghost">Cancel</a>
                <button type="submit" class="ios-button-primary">Create User</button>
            </div>
        </div>
    </form>
</div>
