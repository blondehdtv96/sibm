...
@section('title', 'Tambah Partner Industri')
...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Tambah Partner Industri</h1>
            <p class="text-gray-600 mt-1">Tambahkan logo partner kerjasama baru</p>
        </div>
    </div>

    <!-- Form -->
    <form action="{{ route('admin.industry-partners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
