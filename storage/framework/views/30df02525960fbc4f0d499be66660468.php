...
<section class="py-20 bg-gradient-to-b from-gray-50 to-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <a href="<?php echo e(route('ppdb.check-status')); ?>" 
               class="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                <div class="flex items-center gap-4">
...
<?php echo $__env->make('layouts.public-tailwind', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sibm\resources\views/errors/404.blade.php ENDPATH**/ ?>