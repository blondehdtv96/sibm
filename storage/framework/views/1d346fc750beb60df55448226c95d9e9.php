...
<?php $__env->startSection('title', 'SMK Bina Mandiri Kota Bekasi - Sekolah Menengah Kejuruan Terbaik di Bekasi'); ?>
<?php $__env->startSection('description', 'SMK Bina Mandiri Kota Bekasi adalah sekolah menengah kejuruan terbaik di Bekasi dengan program keahlian unggulan seperti Teknik Komputer Jaringan, Teknik Kendaraan Ringan, dan Teknik Sepeda Motor. Fasilitas modern, guru berpengalaman, tingkat kelulusan 95%. Daftar PPDB 2025 sekarang!'); ?>
<?php $__env->startSection('keywords', 'SMK Bina Mandiri Bekasi, SMK terbaik Bekasi, PPDB SMK Bekasi 2025, sekolah kejuruan Bekasi, program keahlian SMK, TKJ Bekasi, TKR Bekasi, TSM Bekasi, pendaftaran siswa baru SMK'); ?>

<?php $__env->startSection('og_title', 'SMK Bina Mandiri Kota Bekasi - Sekolah Menengah Kejuruan Terbaik di Bekasi'); ?>
<?php $__env->startSection('og_description', 'Bergabunglah dengan SMK Bina Mandiri Bekasi! Program keahlian unggulan, fasilitas modern, guru berpengalaman. Tingkat kelulusan 95%, 1000+ alumni sukses. Daftar PPDB 2025 sekarang!'); ?>
            ...
            <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="swiper-slide">
                    <div class="relative h-[500px] md:h-[600px] lg:h-[650px] bg-gray-900">
                        <!-- Background Image -->
                        <img src="<?php echo e($slider->image_url); ?>" alt="<?php echo e($slider->title); ?>" class="absolute inset-0 w-full h-full object-contain">
...
<section class="relative h-[500px] md:h-[600px] lg:h-[650px] flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-6">
            <?php echo e(config('school.name', 'SMK Bina Mandiri Bekasi')); ?>

        </h1>
        <p class="text-xl md:text-2xl text-white/90 mb-8">
            Membangun Generasi Unggul dengan Pendidikan Berkualitas
        </p>
        <a href="<?php echo e(route('ppdb.register')); ?>" class="inline-flex items-center gap-3 px-8 py-4 bg-white text-blue-600 rounded-2xl font-bold text-lg shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 transition-all">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-blue-600 mb-2"><?php echo e(setting('stat1_value', '1000+')); ?></div>
                <div class="text-gray-600"><?php echo e(setting('stat1_label', 'Alumni Sukses')); ?></div>
            </div>
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-blue-600 mb-2"><?php echo e(setting('stat2_value', '15+')); ?></div>
                <div class="text-gray-600"><?php echo e(setting('stat2_label', 'Program Keahlian')); ?></div>
            </div>
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-blue-600 mb-2"><?php echo e(setting('stat3_value', '50+')); ?></div>
                <div class="text-gray-600"><?php echo e(setting('stat3_label', 'Guru Berpengalaman')); ?></div>
            </div>
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-blue-600 mb-2"><?php echo e(setting('stat4_value', '95%')); ?></div>
                <div class="text-gray-600"><?php echo e(setting('stat4_label', 'Tingkat Kelulusan')); ?></div>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="relative z-10">
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-white/70 text-sm"><?php echo e($announcement->published_at->format('d M Y')); ?></p>
                        </div>
                    </div>
                    <h4 class="text-xl font-bold text-white mb-4 leading-tight"><?php echo e($announcement->title); ?></h4>
                    <p class="text-white/90 mb-6 leading-relaxed text-lg">
                        <?php echo e(Str::limit(strip_tags($announcement->excerpt ?? $announcement->content), 180)); ?>

                    </p>
                    <a href="<?php echo e(route('public.news.show', $announcement->slug)); ?>" 
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div class="relative h-64 lg:h-auto bg-gradient-to-br from-orange-100 to-red-100 flex items-center justify-center p-8">
                    <img src="<?php echo e(asset('storage/' . $ppdbBrochure)); ?>" 
                         alt="<?php echo e($ppdbBrochureTitle); ?>" 
                ...
                <div class="p-8 lg:p-12 flex flex-col justify-center">
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4"><?php echo e($ppdbBrochureTitle); ?></h2>
                    <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                        <?php echo e($ppdbBrochureDescription); ?>

                    </p>
                    
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="<?php echo e(asset('storage/' . $ppdbBrochure)); ?>" 
                           target="_blank"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
                ...
                <div class="relative h-48 overflow-hidden">
                    <img src="<?php echo e(Storage::url($news->featured_image)); ?>" 
                ...
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-3 line-clamp-2 group-hover:text-blue-600 transition-colors">
                        <a href="<?php echo e(route('public.news.show', $news->slug)); ?>">
                    ...
                    <div class="flex items-center justify-between text-sm text-gray-500">
                        ...
                        <?php if($news->author): ?>
                        <span><?php echo e($news->author->name); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
            </article>
...
<?php if($featuredCompetencies->count() > 0): ?>
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Section Header -->
        <div class="text-center mb-12">
        ...
        <!-- Programs Grid -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php $__currentLoopData = $featuredCompetencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $competency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
                <?php if($competency->image): ?>
                <div class="relative h-56 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
                    <img src="<?php echo e(Storage::url($competency->image)); ?>" 
                         alt="<?php echo e($competency->name); ?>"
                ...
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-3 group-hover:text-blue-600 transition-colors">
                        <a href="<?php echo e(route('public.competencies.show', $competency->slug)); ?>">
                            <?php echo e($competency->name); ?>

                        </a>
                    </h3>
                    <p class="text-gray-600 leading-relaxed line-clamp-4">
                        <?php echo e(Str::limit(strip_tags($competency->description), 150)); ?>
...
<!-- Gallery Section -->
<?php if($latestGalleryAlbums->count() > 0): ?>
<section class="py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Section Header -->
        <div class="text-center mb-12">
        ...
        <!-- Gallery Grid -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php $__currentLoopData = $latestGalleryAlbums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $album): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
                <?php if($album->cover_image): ?>
                <div class="relative h-64 overflow-hidden">
                    <img src="<?php echo e(Storage::url($album->cover_image)); ?>" 
                         alt="<?php echo e($album->name); ?>"
                         class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                         loading="lazy">
                </div>
                <?php elseif($album->items->first()): ?>
                <div class="relative h-64 overflow-hidden">
                    <img src="<?php echo e(Storage::url($album->items->first()->image_path)); ?>" 
                         alt="<?php echo e($album->name); ?>"
                         class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                         loading="lazy">
                </div>
                ...
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-2 group-hover:text-blue-600 transition-colors">
                        <a href="<?php echo e(route('public.gallery.show', $album->slug)); ?>">
                    ...
                    <p class="text-gray-600 mb-3 line-clamp-2 leading-relaxed">
                        <?php echo e(Str::limit($album->description, 100)); ?>

                    </p>
                    <?php endif; ?>
                    <p class="text-blue-600 font-semibold">
                        <?php echo e($album->items->count()); ?> <?php echo e(Str::plural('foto', $album->items->count())); ?>
...
<?php echo $__env->make('layouts.public-tailwind', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sibm\resources\views/public/home-new.blade.php ENDPATH**/ ?>