...
<div x-data="{ 
    ...
    class="fixed <?php echo e($position === 'left' ? 'left-6' : 'right-6'); ?> bottom-6 z-50"
    ...
    <div x-show="showTooltip" 
         ...
         class="absolute <?php echo e($position === 'left' ? 'left-full ml-4' : 'right-full mr-4'); ?> bottom-0 mb-2 px-4 py-2 bg-gray-900 text-white text-sm rounded-lg shadow-lg whitespace-nowrap">
        💬 Chat via WhatsApp
        <div class="absolute <?php echo e($position === 'left' ? 'left-0 -ml-2' : 'right-0 -mr-2'); ?> bottom-4 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent <?php echo e($position === 'left' ? 'border-r-8 border-r-gray-900' : 'border-l-8 border-l-gray-900'); ?>"></div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\sibm\resources\views/components/whatsapp-float.blade.php ENDPATH**/ ?>